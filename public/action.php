...
<table style="width: 100%;">';
    ...
    if (!empty($_POST['orgname'])) {
        $html .= ' <tr style="background-color: #f8f8f8;"> <td style="padding: 10px; border: #e9e9e9 1px solid;">Наименование организации:</td>   <td style="padding: 10px; border: #e9e9e9 1px solid;">' . $_POST['orgname'] . '</b></td></tr>';
    }
